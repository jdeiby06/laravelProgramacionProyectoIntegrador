                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="p-2"><?php echo e($mov->venta->cliente->name ?? 'N/A'); ?></td>
                            <td class="p-2">
                                <span class="text-xs px-2 py-1 rounded-full
                                    <?php echo e($mov->venta->estado === 'completado' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                                    <?php echo e(ucfirst($mov->venta->estado ?? 'pendiente')); ?>
